(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=e(n);fetch(n.href,s)}})();const Y=globalThis,rt=Y.ShadowRoot&&(Y.ShadyCSS===void 0||Y.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,At=Symbol(),ct=new WeakMap;let Ot=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==At)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(rt&&t===void 0){const i=e!==void 0&&e.length===1;i&&(t=ct.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&ct.set(e,t))}return t}toString(){return this.cssText}};const C=r=>new Ot(typeof r=="string"?r:r+"",void 0,At),Tt=(r,t)=>{if(rt)r.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const i=document.createElement("style"),n=Y.litNonce;n!==void 0&&i.setAttribute("nonce",n),i.textContent=e.cssText,r.appendChild(i)}},dt=rt?r=>r:r=>r instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return C(e)})(r):r;const{is:St,defineProperty:zt,getOwnPropertyDescriptor:Mt,getOwnPropertyNames:It,getOwnPropertySymbols:Dt,getPrototypeOf:Nt}=Object,B=globalThis,lt=B.trustedTypes,jt=lt?lt.emptyScript:"",Ut=B.reactiveElementPolyfillSupport,q=(r,t)=>r,J={toAttribute(r,t){switch(t){case Boolean:r=r?jt:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,t){let e=r;switch(t){case Boolean:e=r!==null;break;case Number:e=r===null?null:Number(r);break;case Object:case Array:try{e=JSON.parse(r)}catch{e=null}}return e}},st=(r,t)=>!St(r,t),pt={attribute:!0,type:String,converter:J,reflect:!1,useDefault:!1,hasChanged:st};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),B.litPropertyMetadata??(B.litPropertyMetadata=new WeakMap);let I=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=pt){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const i=Symbol(),n=this.getPropertyDescriptor(t,i,e);n!==void 0&&zt(this.prototype,t,n)}}static getPropertyDescriptor(t,e,i){const{get:n,set:s}=Mt(this.prototype,t)??{get(){return this[e]},set(o){this[e]=o}};return{get:n,set(o){const c=n?.call(this);s?.call(this,o),this.requestUpdate(t,c,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??pt}static _$Ei(){if(this.hasOwnProperty(q("elementProperties")))return;const t=Nt(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(q("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(q("properties"))){const e=this.properties,i=[...It(e),...Dt(e)];for(const n of i)this.createProperty(n,e[n])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[i,n]of e)this.elementProperties.set(i,n)}this._$Eh=new Map;for(const[e,i]of this.elementProperties){const n=this._$Eu(e,i);n!==void 0&&this._$Eh.set(n,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const n of i)e.unshift(dt(n))}else t!==void 0&&e.push(dt(t));return e}static _$Eu(t,e){const i=e.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Tt(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){const i=this.constructor.elementProperties.get(t),n=this.constructor._$Eu(t,i);if(n!==void 0&&i.reflect===!0){const s=(i.converter?.toAttribute!==void 0?i.converter:J).toAttribute(e,i.type);this._$Em=t,s==null?this.removeAttribute(n):this.setAttribute(n,s),this._$Em=null}}_$AK(t,e){const i=this.constructor,n=i._$Eh.get(t);if(n!==void 0&&this._$Em!==n){const s=i.getPropertyOptions(n),o=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:J;this._$Em=n;const c=o.fromAttribute(e,s.type);this[n]=c??this._$Ej?.get(n)??c,this._$Em=null}}requestUpdate(t,e,i,n=!1,s){if(t!==void 0){const o=this.constructor;if(n===!1&&(s=this[t]),i??(i=o.getPropertyOptions(t)),!((i.hasChanged??st)(s,e)||i.useDefault&&i.reflect&&s===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,i))))return;this.C(t,e,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:n,wrapped:s},o){i&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,o??e??this[t]),s!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),n===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[n,s]of this._$Ep)this[n]=s;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[n,s]of i){const{wrapped:o}=s,c=this[n];o!==!0||this._$AL.has(n)||c===void 0||this.C(n,void 0,s,c)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(e)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(e=>this._$ET(e,this[e]))),this._$EM()}updated(t){}firstUpdated(t){}};I.elementStyles=[],I.shadowRootOptions={mode:"open"},I[q("elementProperties")]=new Map,I[q("finalized")]=new Map,Ut?.({ReactiveElement:I}),(B.reactiveElementVersions??(B.reactiveElementVersions=[])).push("2.1.2");const F=globalThis,ht=r=>r,Z=F.trustedTypes,ut=Z?Z.createPolicy("lit-html",{createHTML:r=>r}):void 0,_t="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,Pt="?"+E,qt=`<${Pt}>`,z=document,R=()=>z.createComment(""),H=r=>r===null||typeof r!="object"&&typeof r!="function",ot=Array.isArray,Ft=r=>ot(r)||typeof r?.[Symbol.iterator]=="function",it=`[ 	
\f\r]`,U=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ft=/-->/g,mt=/>/g,T=RegExp(`>|${it}(?:([^\\s"'>=/]+)(${it}*=${it}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),gt=/'/g,bt=/"/g,kt=/^(?:script|style|textarea|title)$/i,Lt=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),d=Lt(1),D=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),xt=new WeakMap,S=z.createTreeWalker(z,129);function Et(r,t){if(!ot(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return ut!==void 0?ut.createHTML(t):t}const Rt=(r,t)=>{const e=r.length-1,i=[];let n,s=t===2?"<svg>":t===3?"<math>":"",o=U;for(let c=0;c<e;c++){const a=r[c];let l,u,p=-1,_=0;for(;_<a.length&&(o.lastIndex=_,u=o.exec(a),u!==null);)_=o.lastIndex,o===U?u[1]==="!--"?o=ft:u[1]!==void 0?o=mt:u[2]!==void 0?(kt.test(u[2])&&(n=RegExp("</"+u[2],"g")),o=T):u[3]!==void 0&&(o=T):o===T?u[0]===">"?(o=n??U,p=-1):u[1]===void 0?p=-2:(p=o.lastIndex-u[2].length,l=u[1],o=u[3]===void 0?T:u[3]==='"'?bt:gt):o===bt||o===gt?o=T:o===ft||o===mt?o=U:(o=T,n=void 0);const k=o===T&&r[c+1].startsWith("/>")?" ":"";s+=o===U?a+qt:p>=0?(i.push(l),a.slice(0,p)+_t+a.slice(p)+E+k):a+E+(p===-2?c:k)}return[Et(r,s+(r[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class X{constructor({strings:t,_$litType$:e},i){let n;this.parts=[];let s=0,o=0;const c=t.length-1,a=this.parts,[l,u]=Rt(t,e);if(this.el=X.createElement(l,i),S.currentNode=this.el.content,e===2||e===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(n=S.nextNode())!==null&&a.length<c;){if(n.nodeType===1){if(n.hasAttributes())for(const p of n.getAttributeNames())if(p.endsWith(_t)){const _=u[o++],k=n.getAttribute(p).split(E),G=/([.?@])?(.*)/.exec(_);a.push({type:1,index:s,name:G[2],strings:k,ctor:G[1]==="."?Xt:G[1]==="?"?Qt:G[1]==="@"?Vt:nt}),n.removeAttribute(p)}else p.startsWith(E)&&(a.push({type:6,index:s}),n.removeAttribute(p));if(kt.test(n.tagName)){const p=n.textContent.split(E),_=p.length-1;if(_>0){n.textContent=Z?Z.emptyScript:"";for(let k=0;k<_;k++)n.append(p[k],R()),S.nextNode(),a.push({type:2,index:++s});n.append(p[_],R())}}}else if(n.nodeType===8)if(n.data===Pt)a.push({type:2,index:s});else{let p=-1;for(;(p=n.data.indexOf(E,p+1))!==-1;)a.push({type:7,index:s}),p+=E.length-1}s++}}static createElement(t,e){const i=z.createElement("template");return i.innerHTML=t,i}}function N(r,t,e=r,i){if(t===D)return t;let n=i!==void 0?e._$Co?.[i]:e._$Cl;const s=H(t)?void 0:t._$litDirective$;return n?.constructor!==s&&(n?._$AO?.(!1),s===void 0?n=void 0:(n=new s(r),n._$AT(r,e,i)),i!==void 0?(e._$Co??(e._$Co=[]))[i]=n:e._$Cl=n),n!==void 0&&(t=N(r,n._$AS(r,t.values),n,i)),t}class Ht{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,n=(t?.creationScope??z).importNode(e,!0);S.currentNode=n;let s=S.nextNode(),o=0,c=0,a=i[0];for(;a!==void 0;){if(o===a.index){let l;a.type===2?l=new V(s,s.nextSibling,this,t):a.type===1?l=new a.ctor(s,a.name,a.strings,this,t):a.type===6&&(l=new Wt(s,this,t)),this._$AV.push(l),a=i[++c]}o!==a?.index&&(s=S.nextNode(),o++)}return S.currentNode=z,n}p(t){let e=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class V{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,n){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=N(this,t,e),H(t)?t===f||t==null||t===""?(this._$AH!==f&&this._$AR(),this._$AH=f):t!==this._$AH&&t!==D&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Ft(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==f&&H(this._$AH)?this._$AA.nextSibling.data=t:this.T(z.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,n=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=X.createElement(Et(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===n)this._$AH.p(e);else{const s=new Ht(n,this),o=s.u(this.options);s.p(e),this.T(o),this._$AH=s}}_$AC(t){let e=xt.get(t.strings);return e===void 0&&xt.set(t.strings,e=new X(t)),e}k(t){ot(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,n=0;for(const s of t)n===e.length?e.push(i=new V(this.O(R()),this.O(R()),this,this.options)):i=e[n],i._$AI(s),n++;n<e.length&&(this._$AR(i&&i._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const i=ht(t).nextSibling;ht(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class nt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,n,s){this.type=1,this._$AH=f,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=f}_$AI(t,e=this,i,n){const s=this.strings;let o=!1;if(s===void 0)t=N(this,t,e,0),o=!H(t)||t!==this._$AH&&t!==D,o&&(this._$AH=t);else{const c=t;let a,l;for(t=s[0],a=0;a<s.length-1;a++)l=N(this,c[i+a],e,a),l===D&&(l=this._$AH[a]),o||(o=!H(l)||l!==this._$AH[a]),l===f?t=f:t!==f&&(t+=(l??"")+s[a+1]),this._$AH[a]=l}o&&!n&&this.j(t)}j(t){t===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Xt extends nt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===f?void 0:t}}class Qt extends nt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==f)}}class Vt extends nt{constructor(t,e,i,n,s){super(t,e,i,n,s),this.type=5}_$AI(t,e=this){if((t=N(this,t,e,0)??f)===D)return;const i=this._$AH,n=t===f&&i!==f||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,s=t!==f&&(i===f||n);n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Wt{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){N(this,t)}}const Gt=F.litHtmlPolyfillSupport;Gt?.(X,V),(F.litHtmlVersions??(F.litHtmlVersions=[])).push("3.3.2");const Yt=(r,t,e)=>{const i=e?.renderBefore??t;let n=i._$litPart$;if(n===void 0){const s=e?.renderBefore??null;i._$litPart$=n=new V(t.insertBefore(R(),s),s,void 0,e??{})}return n._$AI(r),n};const L=globalThis;let x=class extends I{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Yt(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return D}};x._$litElement$=!0,x.finalized=!0,L.litElementHydrateSupport?.({LitElement:x});const Kt=L.litElementPolyfillSupport;Kt?.({LitElement:x});(L.litElementVersions??(L.litElementVersions=[])).push("4.2.2");const O=r=>(t,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(r,t)}):customElements.define(r,t)};const Jt={attribute:!0,type:String,converter:J,reflect:!1,hasChanged:st},Zt=(r=Jt,t,e)=>{const{kind:i,metadata:n}=e;let s=globalThis.litPropertyMetadata.get(n);if(s===void 0&&globalThis.litPropertyMetadata.set(n,s=new Map),i==="setter"&&((r=Object.create(r)).wrapped=!0),s.set(e.name,r),i==="accessor"){const{name:o}=e;return{set(c){const a=t.get.call(this);t.set.call(this,c),this.requestUpdate(o,a,r,!0,c)},init(c){return c!==void 0&&this.C(o,void 0,r,c),c}}}if(i==="setter"){const{name:o}=e;return function(c){const a=this[o];t.call(this,c),this.requestUpdate(o,a,r,!0,c)}}throw Error("Unsupported decorator location: "+i)};function h(r){return(t,e)=>typeof e=="object"?Zt(r,t,e):((i,n,s)=>{const o=n.hasOwnProperty(s);return n.constructor.createProperty(s,i),o?Object.getOwnPropertyDescriptor(n,s):void 0})(r,t,e)}function m(r){return h({...r,state:!0,attribute:!1})}const te=(r,t,e)=>(e.configurable=!0,e.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(r,t,e),e);function at(r,t){return(e,i,n)=>{const s=o=>o.renderRoot?.querySelector(r)??null;return te(e,i,{get(){return s(this)}})}}const ee=`
...
`;var ne=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,Bt=(r,t,e,i)=>{for(var n=i>1?void 0:i?ie(t,e):t,s=r.length-1,o;s>=0;s--)(o=r[s])&&(n=(i?o(t,e,n):o(n))||n);return i&&n&&ne(t,e,n),n};let tt=class extends x{constructor(){super(...arguments),this.name="navbar-com"}render(){return d`
             <!-- Header -->
            <header>
        ...
        `}};tt.styles=C(ee);Bt([h()],tt.prototype,"name",2);tt=Bt([O("navbar-com")],tt);const re=`
/* Hero Banner */
.hero-banner {
...
`)}
    ...
    `:d`<p>Cargando producto...</p>`}};M.styles=C(`
  ...
  `);W([h({type:Object})],M.prototype,"product",2);W([h({type:Array})],M.prototype,"similarProducts",2);W([m()],M.prototype,"selectedImageIndex",2);W([m()],M.prototype,"quantity",2);M=W([O("product-detail-com")],M);const fe=`:host {
      display: block;
      width: 100%;
      margin: 0 auto;
    }
...
}`;var ve=Object.defineProperty,we=Object.getOwnPropertyDescriptor,Ct=(r,t,e,i)=>{for(var n=i>1?void 0:i?we(t,e):t,s=r.length-1,o;s>=0;s--)(o=r[s])&&(n=(i?o(t,e,n):o(n))||n);return i&&n&&ve(t,e,n),n};j.pages.push({path:"/",render:()=>d`
    <home-com></home-com>
`});let et=class extends x{constructor(){super(...arguments),this.name="home-com"}render(){const r=e=>d`
      <target-prod-com
        badge="Destacados"
        image=${e.img}
        alt="Promo"
...
`)}
    ...
    `}};et.styles=C($e);Ct([h()],et.prototype,"name",2);et=Ct([O("home-com")],et);const ye=`:host {
    display: block;
    width: 100%;
    max-width: 100%;
    overflow: hidden;
...
@media (max-width: 1024px) {
    ...
    `}};b.styles=C(ye);y([h({type:Array})],b.prototype,"items",2);y([h({attribute:!1})],b.prototype,"renderItem",2);y([h({type:Number})],b.prototype,"itemsPerView",2);y([h({type:Number})],b.prototype,"gap",2);y([m()],b.prototype,"currentIndex",2);y([m()],b.prototype,"isAnimating",2);y([m()],b.prototype,"isDragging",2);y([m()],b.prototype,"startX",2);y([m()],b.prototype,"dragOffset",2);y([at(".shelf-viewport")],b.prototype,"viewport",2);b=y([O("product-shelf-com")],b);var Pe=Object.getOwnPropertyDescriptor,ke=(r,t,e,i)=>{for(var n=i>1?void 0:i?Pe(t,e):t,s=r.length-1,o;s>=0;s--)(o=r[s])&&(n=o(n)||n);return n};let yt=class extends x{constructor(){super(),this.router=new ae(this,j.pages),this.render=()=>d` 
    <navbar-com></navbar-com>
    ${this.router.outlet()}
  `,j.router=this.router}};yt=ke([O("my-element")],yt);
